...
from spflow.modules.layer import CondBinomialLayer as GeneralCondBinomialLayer
...
from spflow.torch.structure.general.node.leaf.cond_binomial import (
    CondBinomial,
)
...
def updateBackend(leaf_node: CondBinomialLayer, dispatch_ctx: Optional[DispatchContext] = None):
    ...
    return GeneralCondBinomialLayer(
