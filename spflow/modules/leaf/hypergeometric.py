...
class Hypergeometric(LeafModule):
    def __init__(
        self, scope: Scope, out_channels: int = None, K: Tensor = None, N: Tensor = None, n: Tensor = None
    ):
        """
        ...
        """
        event_shape = parse_leaf_args(scope=scope, out_channels=out_channels, params=[K, N, n])
