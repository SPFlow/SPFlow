...
from spflow.structure.spn.layer.leaf import GaussianLayer as GeneralGaussianLayer
...
def updateBackend(leaf_node: GaussianLayer, dispatch_ctx: Optional[DispatchContext] = None):
    ...
    """
    dispatch_ctx = init_default_dispatch_context(dispatch_ctx)
    return GeneralGaussianLayer(scope=leaf_node.scopes_out, mean=leaf_node.mean, std=leaf_node.std)
