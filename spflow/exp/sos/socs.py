...
from spflow.exp.sos.inner_product import inner_product_matrix, log_self_inner_product_scalar
from spflow.exp.sos.signed_semiring import signed_logsumexp, sign_of
