...
.. warning::
   RAT-SPN is an **experimental** module located in ``spflow.exp.rat``.
...
The RAT-SPN implementation in SPFlow provides a high-level :class:`spflow.exp.rat.RatSPN` module that automates the construction of the circuit based on architectural hyperparameters.
