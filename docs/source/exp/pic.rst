...
.. warning::
   PIC is an **experimental** module located in ``spflow.exp.pic``.
...
1. **RegionGraph to PIC**: Convert a standard :class:`spflow.meta.region_graph.RegionGraph` into a symbolic PIC using :func:`spflow.exp.pic.rg2pic`.
2. **Functional Sharing**: Attach neural networks (e.g., :class:`spflow.exp.pic.SharedMLP`) to Integral units to allow parameters to be shared across the circuit.
3. **Materialization (PIC to QPC)**: Convert the symbolic PIC into a materialized **Quadrature Product Circuit (QPC)** using :func:`spflow.exp.pic.pic2qpc`. The QPC is a standard SPFlow :class:`spflow.modules.Module` that can be evaluated using ``log_likelihood()``.
...
- :class:`spflow.exp.pic.SharedMLP`: A simple MLP shared across all units in a group.
- :class:`spflow.exp.pic.MultiHeadedMLP`: An MLP with multiple output heads for different units.
- :class:`spflow.exp.pic.FourierFeatures`: Positional encoding for latent variables.
...
- :class:`spflow.exp.pic.TensorizedQPC`: A folded module for efficient PIC inference.
...
.. code-block:: python
    ...
    from spflow.exp.pic import rg2pic, pic2qpc, QuadratureRule, PICInput
...
.. autofunction:: spflow.exp.pic.rg2pic

.. autofunction:: spflow.exp.pic.pic2qpc

.. autoclass:: spflow.exp.pic.MergeStrategy
   :members:

.. autoclass:: spflow.exp.pic.QuadratureRule
   :members:

Integral and Sum Units
----------------------

.. autoclass:: spflow.exp.pic.Integral
   :members:
   :show-inheritance:

.. autoclass:: spflow.exp.pic.PICSum
   :members:
   :show-inheritance:

.. autoclass:: spflow.exp.pic.PICProduct
   :members:
   :show-inheritance:

.. autoclass:: spflow.exp.pic.WeightedSum
   :members:
   :show-inheritance:
...
.. autoclass:: spflow.exp.pic.SharedMLP
   :members:
   :show-inheritance:

.. autoclass:: spflow.exp.pic.MultiHeadedMLP
   :members:
   :show-inheritance:

.. autoclass:: spflow.exp.pic.FourierFeatures
   :members:
   :show-inheritance:

.. autoclass:: spflow.exp.pic.FunctionGroup
   :members:
   :show-inheritance:
...
.. autoclass:: spflow.exp.pic.TensorizedQPC
   :members:
   :show-inheritance:

.. autoclass:: spflow.exp.pic.TensorizedQPCConfig
   :members:
