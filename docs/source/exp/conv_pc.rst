...
.. warning::
   ConvPc is an **experimental** module located in ``spflow.exp.conv``.
...
The :class:`spflow.exp.conv.ConvPc` module automates the construction of these circuits for image modeling.

.. autoclass:: spflow.exp.conv.ConvPc
   :members:
   :show-inheritance:
