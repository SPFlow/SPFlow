...
from spflow.base.structure.general.node.leaf.geometric import Geometric
from spflow.structure.spn.layer.leaf import GeometricLayer as GeneralGeometricLayer
