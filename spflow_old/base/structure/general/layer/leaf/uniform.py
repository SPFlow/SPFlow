...
from spflow.structure.spn.layer.leaf import UniformLayer as GeneralUniformLayer
...
class UniformLayer(Module):
    ...
    def set_params(
        ...
        for node_start, node_end, node_support_outside, node in zip(start, end, support_outside, self.nodes):
            ...
            node.set_parameters(node_start, node_end, node_support_outside)
