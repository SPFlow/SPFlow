...
from spflow.base.structure.general.node.leaf.log_normal import (
    LogNormal as BaseLogNormal,
)
from spflow.structure.general.node.leaf.general_log_normal import LogNormal as GeneralLogNormal
