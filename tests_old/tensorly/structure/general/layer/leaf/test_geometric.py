...
from spflow.base.structure.general.node.leaf.geometric import Geometric as GeometricBase
from spflow.base.structure.general.layer.leaf.geometric import GeometricLayer as GeometricLayerBase
from spflow.meta.data import FeatureContext, FeatureTypes, Scope
from spflow.torch.structure import marginalize
from spflow.torch.structure.general.node.leaf.geometric import Geometric as GeometricTorch
from spflow.torch.structure.general.layer.leaf.geometric import GeometricLayer as GeometricLayerTorch
...
def test_layer_dist(do_for_all_backends):
    ...
    for p_value, p_dist in zip(p_values, p_list):
        tc.assertTrue(np.allclose(p_value, tle.toNumpy(p_dist)))
