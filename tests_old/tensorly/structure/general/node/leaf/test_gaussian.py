...
def test_initialization_from_signatures(do_for_all_backends):
    ...
    tc.assertTrue(np.isclose(tle.toNumpy(gaussian.mean), tl.tensor(0.0)))
    tc.assertTrue(np.isclose(tle.toNumpy(gaussian.std), tl.tensor(1.0)))
    ...
    tc.assertTrue(np.isclose(tle.toNumpy(gaussian.mean), tl.tensor(-1.0)))
    tc.assertTrue(np.isclose(tle.toNumpy(gaussian.std), tl.tensor(1.5)))
    # ----- invalid arguments -----
...
def test_autoleaf(do_for_all_backends):
    ...
    tc.assertTrue(np.isclose(tle.toNumpy(gaussian.mean), tl.tensor(-1.0)))
    tc.assertTrue(np.isclose(tle.toNumpy(gaussian.std), tl.tensor(0.5)))
