...
def test_initialization_from_signatures(do_for_all_backends):
    ...
    tc.assertTrue(np.isclose(tle.toNumpy(log_normal.mean), tl.tensor(0.0)))
    tc.assertTrue(np.isclose(tle.toNumpy(log_normal.std), tl.tensor(1.0)))
    ...
    tc.assertTrue(np.isclose(tle.toNumpy(log_normal.mean), tl.tensor(-1.0)))
    tc.assertTrue(np.isclose(tle.toNumpy(log_normal.std), tl.tensor(1.5)))
...
def test_autoleaf(do_for_all_backends):
    ...
    tc.assertTrue(np.isclose(tle.toNumpy(log_normal.mean), tl.tensor(-1.0)))
    tc.assertTrue(np.isclose(tle.toNumpy(log_normal.std), tl.tensor(0.5)))
