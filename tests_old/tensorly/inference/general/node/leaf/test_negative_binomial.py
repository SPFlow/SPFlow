...
from spflow.structure.spn import NegativeBinomial
from spflow.meta.data import Scope
from spflow.modules.module import log_likelihood, likelihood
from spflow.base.structure.general.node.leaf.negative_binomial import NegativeBinomial as BaseNegativeBinomial
