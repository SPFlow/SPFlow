...
from spflow.structure.spn import Uniform
from spflow.meta.data import Scope
from spflow.modules.module import log_likelihood, likelihood
from spflow.base.structure.general.node.leaf.uniform import Uniform as BaseUniform
...
def test_inference(do_for_all_backends):
    ...
    data_torch = tl.tensor(data_np, dtype=tl.float32)
