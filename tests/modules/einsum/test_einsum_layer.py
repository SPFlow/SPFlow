"""Differentiable sampling tests for EinsumLayer."""
...
def test_rsample_two_inputs_routes_and_backpropagates():
    module = make_einsum_two_inputs(in_channels=2, out_channels=3, in_features=4, num_repetitions=2)
...
def test_rsample_single_input_split_routes_and_backpropagates():
    module = make_einsum_single_input(in_channels=2, out_channels=3, in_features=4, num_repetitions=2)
