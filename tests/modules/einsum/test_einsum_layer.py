...
def make_einsum_single_input(
    ...
    """Create EinsumLayer with single input module (split internally)."""
...
class TestEinsumLayerConstruction:
    """Test EinsumLayer construction and initialization."""
    ...
    def test_single_input_construction(
        ...
        """Test constructing EinsumLayer with single input."""
    ...
    def test_two_input_construction(
        ...
        """Test constructing EinsumLayer with two inputs."""
...
class TestEinsumLayerLogLikelihood:
    """Test EinsumLayer log-likelihood computation."""
...
class TestEinsumLayerWeights:
    """Test EinsumLayer weight properties."""

    def test_weights_normalized(self):
        """Test that weights sum to 1 over (i,j) pairs."""
...
class TestEinsumLayerMarginalization:
    """Test EinsumLayer marginalization."""
    ...
    def test_marginalize_no_overlap(self):
        ...
        # Should return an EinsumLayer
        assert isinstance(marg_module, EinsumLayer)


class TestEinsumLayerGradientDescent:
...
class TestEinsumLayerSplitOptimization:
    ...
    def test_split_input_not_wrapped(self):
        ...
        # Create EinsumLayer with the SplitConsecutive input
    ...
    def test_split_input_produces_same_output(self):
        ...
        # Create two EinsumLayers: one with leaf (will wrap), one with SplitConsecutive
        split_mode = SplitConsecutive(leaf)
