...
class SimpleLeafWithLogParam(LeafModule):
    """Simple test leaf module with LogSpaceParameter."""
...
class LeafWithMultipleLogParams(LeafModule):
    """Test leaf with multiple LogSpaceParameters."""
...
@pytest.fixture
def simple_leaf():
    """Fixture providing a simple leaf module with LogSpaceParameter."""
    return SimpleLeafWithLogParam(Scope([0, 1]))


@pytest.fixture
def multi_param_leaf():
    """Fixture providing a leaf with multiple LogSpaceParameters."""
...
class TestPyTorchIntegration:
    ...
    def test_state_dict_save_and_load(self, simple_leaf):
        ...
        # Create new leaf with same scope (same shape)
