...
class SimpleLeafWithBoundedParam(LeafModule):
    """Simple test leaf module with BoundedParameter."""
...
class LeafWithMultipleBoundedParams(LeafModule):
    """Test leaf with multiple BoundedParameters with different bounds."""
...
class LeafWithLowerBoundedParam(LeafModule):
    """Test leaf with lower-bounded parameter only."""
...
@pytest.fixture
def simple_leaf():
    """Fixture providing a simple leaf module with BoundedParameter."""
    return SimpleLeafWithBoundedParam(Scope([0, 1]))


@pytest.fixture
def multi_param_leaf():
    """Fixture providing a leaf with multiple BoundedParameters."""
    return LeafWithMultipleBoundedParams(Scope([0, 1, 2]))


@pytest.fixture
def lower_bounded_leaf():
    """Fixture providing a leaf with lower-bounded parameter only."""
...
class TestPyTorchIntegration:
    ...
    def test_state_dict_save_and_load(self, simple_leaf):
        ...
        # Create new leaf with same scope
