...
class TestNode(unittest.TestCase):
    def test_spn_fail_scope1(self):
        context = Context(parametric_types=[Gaussian, Gaussian])
    ...
    def test_spn_fail_scope2(self):
        with self.assertRaises(IndexError):
            context = Context(parametric_types=[Gaussian])
            spn_module: Node = ProductNode(
                children=[
    ...
    def test_spn_tree_big(self):
        context = Context(parametric_types=[Gaussian, Gaussian, Gaussian, Gaussian, Gaussian])
        spn_module: Node = ProductNode(
            children=[
                SumNode(
                    children=[
