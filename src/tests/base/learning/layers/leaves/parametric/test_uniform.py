...
from spflow.base.learning.layers.leaves.parametric.uniform import maximum_likelihood_estimation
...
class TestNode(unittest.TestCase):
    def test_mle(self):
        ...
        # simulate data
        data = np.hstack([np.random.uniform(low=-3.0, high=-1.0, size=(100,1)), np.random.uniform(low=0.0, high=1.0, size=(100,1))])
