...
from spflow.base.inference.layers.leaves.parametric.bernoulli import log_likelihood
...
class TestNode(unittest.TestCase):
    def test_sampling_1(self):
        ...
        bernoulli_nodes = [Bernoulli(Scope([0]), p=0.8), Bernoulli(Scope([0]), p=0.3)]
    ...
    def test_sampling_2(self):
        ...
        bernoulli_nodes = [Bernoulli(Scope([0]), p=0.8), Bernoulli(Scope([1]), p=0.3)]
