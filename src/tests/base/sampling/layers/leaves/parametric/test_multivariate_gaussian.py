...
from spflow.base.sampling.layers.leaves.parametric.multivariate_gaussian import sample
...
class TestNode(unittest.TestCase):
    def test_sampling_1(self):
        ...
        multivariate_gaussian_nodes = [MultivariateGaussian(Scope([0,1]), mean=[0.8, 0.3], cov=[[0.13, 0.08], [0.08, 0.05]]), MultivariateGaussian(Scope([0,1]), mean=[0.2, -0.1], cov=[[0.17, 0.054], [0.054, 0.0296]])]
    ...
    def test_sampling_2(self):
        ...
        multivariate_gaussian_nodes = [MultivariateGaussian(Scope([0,1]), mean=[0.8, 0.3], cov=[[0.13, 0.08], [0.08, 0.05]]), MultivariateGaussian(Scope([2,3]), mean=[0.2, -0.1], cov=[[0.17, 0.054], [0.054, 0.0296]])]
