...
class TestNode(unittest.TestCase):
    def test_sampling_1(self):
        ...
        gamma_nodes = [Gamma(Scope([0]), alpha=0.8, beta=1.3), Gamma(Scope([0]), alpha=0.3, beta=0.4)]
    ...
    def test_sampling_2(self):
        ...
        gamma_nodes = [Gamma(Scope([0]), alpha=0.8, beta=1.3), Gamma(Scope([1]), alpha=0.3, beta=0.4)]
