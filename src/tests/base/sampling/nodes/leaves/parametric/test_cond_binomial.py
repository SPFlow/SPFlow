...
class TestCondBinomial(unittest.TestCase):
    def test_sampling_1(self):
        ...
        binomial = CondBinomial(Scope([0]), n=10, cond_f=lambda data: {'p': 0.0})
    ...
    def test_sampling_2(self):
        ...
        binomial = CondBinomial(Scope([0]), n=10, cond_f=lambda data: {'p': 1.0})
    ...
    def test_sampling_3(self):
        ...
        binomial = CondBinomial(Scope([0]), n=10, cond_f=lambda data: {'p': 0.5})
