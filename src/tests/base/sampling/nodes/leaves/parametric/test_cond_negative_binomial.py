...
class TestCondNegativeBinomial(unittest.TestCase):
    ...
    def test_sampling_2(self):
        ...
        negative_binomial = CondNegativeBinomial(Scope([0]), n=10, cond_f=lambda data: {'p': 0.3})
    ...
    def test_sampling_3(self):
        ...
        negative_binomial = CondNegativeBinomial(Scope([0]), n=5, cond_f=lambda data: {'p': 0.8})
