...
from spflow.base.inference.layers.leaves.parametric.uniform import log_likelihood
...
class TestNode(unittest.TestCase):
    def test_layer_likelihood_1(self):
        ...
        uniform_nodes = [Uniform(Scope([0]), start=0.4, end=1.3), Uniform(Scope([0]), start=0.3, end=0.8)]
    ...
    def test_layer_likelihood_2(self):
        ...
        uniform_nodes = [Uniform(Scope([0]), start=0.4, end=1.3), Uniform(Scope([1]), start=0.3, end=0.8)]
