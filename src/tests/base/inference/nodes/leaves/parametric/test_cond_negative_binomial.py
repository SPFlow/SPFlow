...
class TestCondNegativeBinomial(unittest.TestCase):
    ...
    def test_likelihood_1(self):
        ...
        # ----- configuration 1 -----
        negative_binomial = CondNegativeBinomial(Scope([0]), n=10, cond_f=lambda data: {'p': 0.4})
    ...
    def test_likelihood_2(self):
        ...
        # ----- configuration 2 -----
        negative_binomial = CondNegativeBinomial(Scope([0]), n=20, cond_f=lambda data: {'p': 0.3})
    ...
    def test_likelihood_p_1(self):
        ...
        # p = 1
        negative_binomial = CondNegativeBinomial(Scope([0]), n=1, cond_f=lambda data: {'p': 1.0})
    ...
    def test_likelihood_p_none(self):
        ...
        negative_binomial = CondNegativeBinomial(Scope([0]), n=1, cond_f=lambda data: {'p': None})
    ...
    def test_likelihood_n_none(self):
        ...
        negative_binomial = CondNegativeBinomial(Scope([0]), n=1, cond_f=lambda data: {'p': 0.5})
