...
class TestNode(unittest.TestCase):
    ...
    def test_kmeans_initialization(self):
        ...
        self.assertRaises(ValueError, kmeans, torch.randn((3,4)), n_clusters=2, centroids='invalid_init_strategy')
        ...
        self.assertRaises(ValueError, kmeans, torch.randn((3,4)), n_clusters=3, centroids=torch.randn((2, 4)))
        # number of feature dimensions for specified centroids does not match data
        self.assertRaises(ValueError, kmeans, torch.randn((3,4)), n_clusters=3, centroids=torch.randn((3, 3)))
        # valid centroids
    ...
    def test_kmeans_clustering(self):
        ...
        torch_centroids, torch_labels = kmeans(torch.tensor(data), n_clusters=3, centroids=torch.tensor(starting_centroids))
