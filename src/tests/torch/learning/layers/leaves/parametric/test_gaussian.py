...
from spflow.torch.learning.layers.leaves.parametric.gaussian import maximum_likelihood_estimation, em
...
class TestNode(unittest.TestCase):
    ...
    def test_mle_nan_strategy_ignore(self):
        ...
        layer = GaussianLayer(Scope([0]))
        maximum_likelihood_estimation(layer, torch.tensor([[float("nan")], [0.1], [-1.8], [0.7]]), nan_strategy='ignore', bias_correction=False)
