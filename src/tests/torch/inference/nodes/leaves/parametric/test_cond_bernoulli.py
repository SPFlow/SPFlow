...
from spflow.torch.structure.nodes.leaves.parametric.cond_bernoulli import CondBernoulli, toBase, toTorch
...
class TestBernoulli(unittest.TestCase):
    ...
    def test_inference(self):
        ...
        torch_bernoulli = CondBernoulli(Scope([0]), cond_f=lambda data: {'p': torch.tensor(p)})
        node_bernoulli = BaseCondBernoulli(Scope([0]), cond_f=lambda data: {'p': p})
    ...
    def test_gradient_computation(self):
        ...
        torch_bernoulli = CondBernoulli(Scope([0]), cond_f=lambda data: {'p': p})
    ...
    def test_likelihood_marginalization(self):
        ...
        bernoulli = CondBernoulli(Scope([0]), cond_f=lambda data: {'p': random.random()})
