...
from spflow.torch.inference.layers.leaves.parametric.cond_geometric import log_likelihood
...
class TestNode(unittest.TestCase):
    ...
    def test_layer_likelihood(self):
        ...
        layer = CondGeometricLayer(scope=[Scope([0]), Scope([1]), Scope([0])], cond_f=lambda data: {'p': [0.2, 1.0, 0.3]})
    ...
    def test_gradient_computation(self):
        ...
        torch_geometric = CondGeometricLayer(scope=[Scope([0]), Scope([1])], cond_f=lambda data: {'p': p})
    ...
    def test_likelihood_marginalization(self):
        ...
        geometric = CondGeometricLayer(scope=[Scope([0]), Scope([1])], cond_f=lambda data: {'p': random.random()+1e-7})
