...
class TestNode(unittest.TestCase):
    ...
    def test_sum_node_sampling(self):
        ...
        s = SPNCondSumNode([l1, l2], cond_f=lambda data: {'weights': [0.001, 0.999]})
        ...
        s = SPNCondSumNode([l1, l2], cond_f=lambda data: {'weights': [0.999, 0.001]})
        ...
        s = SPNCondSumNode([l1, l2], cond_f=lambda data: {'weights': [0.2, 0.8]})
