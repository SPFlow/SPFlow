...
from spflow.torch.sampling.nodes.leaves.parametric.negative_binomial import (
    sample,
)
...
from spflow.torch.sampling.layers.leaves.parametric.negative_binomial import (
    sample,
)
