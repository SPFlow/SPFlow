...
from spflow.torch.sampling.layers.leaves.parametric.cond_bernoulli import sample
...
class TestNode(unittest.TestCase):
    ...
    def test_layer_sampling(self):
        ...
        layer = CondBernoulliLayer(scope=[Scope([0]), Scope([1]), Scope([0])], cond_f=lambda data: {'p': [0.2, 0.8, 0.2]})
        ...
        expected_mean = torch.tensor([0.2, 0.8])
