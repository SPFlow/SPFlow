...
from spflow.torch.sampling.nodes.leaves.parametric.cond_exponential import sample
...
from spflow.torch.sampling.layers.leaves.parametric.cond_exponential import sample
...
class TestNode(unittest.TestCase):
    ...
    def test_layer_sampling(self):
        ...
        layer = CondExponentialLayer(scope=[Scope([0]), Scope([1]), Scope([0])], cond_f=lambda data: {'l': [0.2, 1.8, 0.2]})
