...
class TestNode(unittest.TestCase):
    def test_input_to_output_id_1(self):
        ...
        s = SPNSumNode([DummyNode(Scope([0])), DummyNode(Scope([0])), DummyNode(Scope([0])), DummyNode(Scope([0])), DummyNode(Scope([0]))])
    ...
    def test_input_to_output_id_2(self):
        ...
        s = SPNSumNode([DummyModule(n=2, scope=Scope([0])), DummyNode(Scope([0])), DummyModule(n=3, scope=Scope([0]))])
    ...
    def test_input_to_output_id_3(self):
        ...
        s = DummyNestedModule(children=[DummyModule(n=2, scope=Scope([0])), DummyNode(Scope([0])), DummyModule(n=3, scope=Scope([0]))])
