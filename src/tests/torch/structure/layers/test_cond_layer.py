from spflow.torch.structure.layers.cond_layer import SPNCondSumLayer, marginalize, toBase, toTorch
...
class TestNode(unittest.TestCase):
    ...
    def test_sum_layer_backend_conversion_1(self):
        ...
        torch_sum_layer = SPNCondSumLayer(n_nodes=3, children=[Gaussian(Scope([0])), Gaussian(Scope([0])), Gaussian(Scope([0]))])
    ...
    def test_sum_layer_backend_conversion_2(self):
        ...
        base_sum_layer = BaseSPNCondSumLayer(n_nodes=3, children=[BaseGaussian(Scope([0])), BaseGaussian(Scope([0])), BaseGaussian(Scope([0]))])
