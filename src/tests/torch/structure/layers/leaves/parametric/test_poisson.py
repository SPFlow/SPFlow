from spflow.torch.structure.layers.leaves.parametric.poisson import PoissonLayer, marginalize, toTorch, toBase
...
class TestNode(unittest.TestCase):
    ...
    def test_layer_initialization(self):
        ...
        self.assertRaises(ValueError, PoissonLayer, Scope([0]), [l_values for _ in range(3)], n_nodes=3)
        ...
        # wrong number of values
        self.assertRaises(ValueError, PoissonLayer, Scope([0]), np.array(l_values[:-1]), n_nodes=3)
        self.assertRaises(ValueError, PoissonLayer, Scope([0]), np.array([l_values for _ in range(3)]), n_nodes=3)
