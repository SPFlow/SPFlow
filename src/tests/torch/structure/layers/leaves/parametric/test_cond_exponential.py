from spflow.torch.structure.layers.leaves.parametric.cond_exponential import CondExponentialLayer, marginalize, toTorch, toBase
...
class TestNode(unittest.TestCase):
    ...
    def test_layer_initialization(self):
        ...
        self.assertRaises(ValueError, CondExponentialLayer, Scope([0]), n_nodes=0)
        ...
        CondExponentialLayer(Scope([0]), n_nodes=2, cond_f=[lambda data: {'l': 1.5}, lambda data: {'l': 1.5}])
        self.assertRaises(ValueError, CondExponentialLayer, Scope([0]), n_nodes=2, cond_f=[lambda data: {'l': 0.5}])

    def test_retrieve_params(self):

        # ----- float/int parameter values -----
        l_value = 0.73
        l = CondExponentialLayer(scope=Scope([1]), n_nodes=3, cond_f=lambda data: {'l': l_value})
        ...
        l = CondExponentialLayer(scope=Scope([1]), n_nodes=3, cond_f=lambda data: {'l': l_values})
    ...
    def test_layer_backend_conversion_1(self):
        ...
        torch_layer = CondExponentialLayer(scope=[Scope([0]), Scope([1]), Scope([0])])
    ...
    def test_layer_backend_conversion_2(self):
        ...
        base_layer = BaseCondExponentialLayer(scope=[Scope([0]), Scope([1]), Scope([0])])
