from spflow.torch.structure.layers.leaves.parametric.cond_log_normal import CondLogNormalLayer, marginalize, toTorch, toBase
...
class TestNode(unittest.TestCase):
    ...
    def test_retrieve_params(self):
        ...
        l = CondLogNormalLayer(scope=Scope([1]), n_nodes=3, cond_f=lambda data: {'mean': mean_values, 'std': std_values})
    ...
    def test_layer_backend_conversion_1(self):
        ...
        torch_layer = CondLogNormalLayer(scope=[Scope([0]), Scope([1]), Scope([0])])
    ...
    def test_layer_backend_conversion_2(self):
        ...
        base_layer = BaseCondLogNormalLayer(scope=[Scope([0]), Scope([1]), Scope([0])])
