from spflow.torch.structure.layers.leaves.parametric.cond_negative_binomial import CondNegativeBinomialLayer, marginalize, toTorch, toBase
...
class TestNode(unittest.TestCase):
    ...
    def test_layer_initialization(self):
        ...
        l = CondNegativeBinomialLayer(scope=[Scope([1]), Scope([0]), Scope([2])], n=2)
        ...
        # ----- n initialization -----
        l = CondNegativeBinomialLayer(scope=[Scope([1]), Scope([0]), Scope([2])], n=[3, 5, 2])
        # wrong number of n values
        self.assertRaises(ValueError, CondNegativeBinomialLayer, [Scope([1]), Scope([0]), Scope([2])], n=[3, 5], n_nodes=3)
        # wrong shape of n values
        self.assertRaises(ValueError, CondNegativeBinomialLayer, [Scope([1]), Scope([0]), Scope([2])], [[3, 5] for _ in range(3)], n_nodes=3)

        # n numpy array
        l = CondNegativeBinomialLayer(scope=[Scope([1]), Scope([0]), Scope([2])], n=np.array([3, 5, 2]))
        # wrong number of n values
        self.assertRaises(ValueError, CondNegativeBinomialLayer, scope=[Scope([1]), Scope([0]), Scope([2])], n=np.array([3, 5]))
        # wrong shape of n values
        self.assertRaises(ValueError, CondNegativeBinomialLayer, scope=[Scope([1]), Scope([0]), Scope([2])], n=np.array([[3, 5, 2]]))

        # ---- different scopes -----
        l = CondNegativeBinomialLayer(scope=Scope([1]), n_nodes=3, n=2)
        for layer_scope, node_scope in zip(l.scopes_out, l.scopes_out):
            self.assertEqual(layer_scope, node_scope)

        # ----- invalid number of nodes -----
        self.assertRaises(ValueError, CondNegativeBinomialLayer, Scope([0]), n_nodes=0, n=2)
        ...
        l = CondNegativeBinomialLayer(scope=[Scope([1]), Scope([0])], n_nodes=3, n=2)

        for layer_scope, node_scope in zip(l.scopes_out, scopes):
            self.assertEqual(layer_scope, node_scope)

        # -----number of cond_f functions -----
        CondNegativeBinomialLayer(Scope([0]), n=3, n_nodes=2, cond_f=[lambda data: {'p': 0.5}, lambda data: {'p': 0.5}])
        self.assertRaises(ValueError, CondNegativeBinomialLayer, Scope([0]), n=3, n_nodes=2, cond_f=[lambda data: {'p': 0.5}])
    ...
    def test_retrieve_params(self):
        ...
        n_value = 5
        p_value = 0.13
        l = CondNegativeBinomialLayer(scope=Scope([1]), n_nodes=3, n=n_value, cond_f=lambda data: {'p': p_value})
        ...
        l = CondNegativeBinomialLayer(scope=[Scope([1]), Scope([0]), Scope([2])], n=n_values, cond_f=lambda data: {'p': p_values})

        for n_value, p_value, n_layer_node, p_layer_node in zip(n_values, p_values, l.n, l.retrieve_params(torch.tensor([[1]]), DispatchContext())):
        ...
        for p_node, p_actual in zip(l.retrieve_params(torch.tensor([[1.0]]), DispatchContext()), p_values):
    ...
    def test_layer_structural_marginalization(self):
        ...
        l = CondNegativeBinomialLayer(scope=Scope([1]), n_nodes=2, n=2)
        ...
        l = CondNegativeBinomialLayer(scope=[Scope([1]), Scope([0])], n=[3, 2])
    ...
    def test_layer_dist(self):
        ...
        l = CondNegativeBinomialLayer(scope=[Scope([1]), Scope([0]), Scope([2])], n=n_values)
    ...
    def test_layer_backend_conversion_1(self):
        ...
        torch_layer = CondNegativeBinomialLayer(scope=[Scope([0]), Scope([1]), Scope([0])], n=[2, 5, 2])
    ...
    def test_layer_backend_conversion_2(self):
        ...
        base_layer = BaseCondNegativeBinomialLayer(scope=[Scope([0]), Scope([1]), Scope([0])], n=[2, 5, 2])
