...
class TestNode(unittest.TestCase):
    ...
    def test_layer_initialization(self):
        ...
        l = CondNegativeBinomialLayer(
            scope=[Scope([1]), Scope([0]), Scope([2])], n=2
        )
        ...
        self.assertRaises(
            ValueError, CondNegativeBinomialLayer, Scope([0]), n_nodes=0, n=2
        )
    ...
    def test_layer_dist(self):
        ...
        l = CondNegativeBinomialLayer(
            scope=[Scope([1]), Scope([0]), Scope([2])], n=n_values
        )
    ...
    def test_layer_backend_conversion_1(self):
        ...
        torch_layer = CondNegativeBinomialLayer(
            scope=[Scope([0]), Scope([1]), Scope([0])], n=[2, 5, 2]
        )
