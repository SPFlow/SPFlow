from spflow.torch.structure.layers.leaves.parametric.cond_geometric import CondGeometricLayer, marginalize, toTorch, toBase
...
class TestNode(unittest.TestCase):
    ...
    def test_retrieve_params(self):
        ...
        l = CondGeometricLayer(scope=Scope([1]), n_nodes=3, cond_f=lambda data: {'p': p_values})
    ...
    def test_layer_backend_conversion_1(self):
        ...
        torch_layer = CondGeometricLayer(scope=[Scope([0]), Scope([1]), Scope([0])])
    ...
    def test_layer_backend_conversion_2(self):
        ...
        base_layer = BaseCondGeometricLayer(scope=[Scope([0]), Scope([1]), Scope([0])])
