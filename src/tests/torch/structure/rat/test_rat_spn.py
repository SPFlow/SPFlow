...
from spflow.torch.structure.layers.layer import SPNSumLayer, SPNPartitionLayer, SPNHadamardLayer, marginalize
from spflow.torch.structure.layers.leaves.parametric.gaussian import GaussianLayer, marginalize
from spflow.torch.structure.nodes.node import SPNSumNode
from spflow.torch.structure.rat.rat_spn import RatSPN, marginalize, toBase, toTorch
...
class TestRatSpn(unittest.TestCase):
    def test_rat_spn_initialization(self):
        ...
        self.assertRaises(ValueError, RatSPN, region_graph, n_root_nodes=0, n_region_nodes=1, n_leaf_nodes=1)
        self.assertRaises(ValueError, RatSPN, region_graph, n_root_nodes=1, n_region_nodes=0, n_leaf_nodes=1)
        self.assertRaises(ValueError, RatSPN, region_graph, n_root_nodes=1, n_region_nodes=1, n_leaf_nodes=0)
    ...
    def test_rat_spn_1(self):
        ...
        rat_spn = RatSPN(region_graph, n_root_nodes=1, n_region_nodes=1, n_leaf_nodes=1)
    ...
    def test_rat_spn_2(self):
        ...
        random_variables = list(range(7))
        region_graph = random_region_graph(Scope(random_variables), depth=3, replicas=1)
    ...
    def test_rat_spn_3(self):
        ...
        random_variables = list(range(7))
        region_graph = random_region_graph(Scope(random_variables), depth=3, replicas=2)

        rat_spn = RatSPN(region_graph, n_root_nodes=2, n_region_nodes=2, n_leaf_nodes=2)
    ...
    def test_rat_spn_4(self):
        ...
        random_variables = list(range(7))
        region_graph = random_region_graph(Scope(random_variables), depth=3, replicas=3)

        rat_spn = RatSPN(region_graph, n_root_nodes=3, n_region_nodes=3, n_leaf_nodes=3)
    ...
    def test_rat_spn_5(self):
        ...
        random_variables = list(range(7))
        region_graph = random_region_graph(Scope(random_variables), depth=2, replicas=1, n_splits=3)
    ...
    def test_rat_spn_6(self):
        ...
        region_graph = random_region_graph(Scope(random_variables), depth=3, replicas=1, n_splits=3)
    ...
    def test_rat_spn_7(self):
        ...
        random_variables = list(range(7))
        region_graph = random_region_graph(Scope(random_variables), depth=2, replicas=2, n_splits=3)
    ...
    def test_rat_spn_8(self):
        ...
        region_graph = random_region_graph(Scope(random_variables), depth=3, replicas=3, n_splits=3)

        rat_spn = RatSPN(region_graph, n_root_nodes=3, n_region_nodes=3, n_leaf_nodes=2)
    ...
    def test_rat_spn_backend_conversion_1(self):
        ...
        torch_rat = RatSPN(region_graph, n_root_nodes=4, n_region_nodes=2, n_leaf_nodes=3)
        ...
        while modules:
            ...
            if isinstance(module, GaussianLayer):
                module.set_params(mean=torch.randn(module.mean.shape), std=torch.rand(module.std.shape) + 1e-8)
    ...
    def test_rat_spn_backend_conversion_2(self):
        ...
        # create torch rat spn from region graph
        base_rat = BaseRatSPN(region_graph, n_root_nodes=4, n_region_nodes=2, n_leaf_nodes=3)
        ...
        while modules:
            ...
            if isinstance(module, BaseGaussianLayer):
                module.set_params(mean=np.random.randn(*module.mean.shape), std=np.random.rand(*module.std.shape) + 1e-8)
