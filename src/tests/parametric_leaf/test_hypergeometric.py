...
class TestHypergeometric(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        # N float
        self.assertRaises(Exception, Hypergeometric, [0], 1.5, 1, 1)
