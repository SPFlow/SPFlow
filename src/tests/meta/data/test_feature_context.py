...
class TestFeatureContext(unittest.TestCase):
    def test_feature_context_initialization(self):
        ...
        feature_ctx = FeatureContext(
            Scope([0, 1, 2, 3]),
            {
                0: FeatureTypes.Continuous,
                2: FeatureTypes.Discrete
            }
        )
        ...
        self.assertRaises(ValueError, FeatureContext, Scope([0, 1]), {0: FeatureTypes.Continuous, 2: FeatureTypes.Discrete})
    ...
    def test_set_domains(self):
        ...
        self.assertRaises(ValueError, feature_ctx.set_domains, {0: FeatureTypes.Discrete}, overwrite=False)
    ...
    def test_get_domains(self):
        ...
        self.assertEqual(feature_ctx.get_domains([2, 0]), [FeatureTypes.Discrete, FeatureTypes.Continuous]) # also tests if order is correct
