...
from spflow.tensorly.structure.spn.layer.product_layer import toLayerBased, toNodeBased
from spflow.tensorly.structure.spn.layer_layerbased.product_layer import toLayerBased, toNodeBased, updateBackend
