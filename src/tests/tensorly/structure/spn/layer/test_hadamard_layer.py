...
from spflow.tensorly.structure.spn.layer.hadamard_layer import toLayerBased, toNodeBased
from spflow.tensorly.structure.spn.layer_layerbased.hadamard_layer import toLayerBased, toNodeBased, updateBackend
