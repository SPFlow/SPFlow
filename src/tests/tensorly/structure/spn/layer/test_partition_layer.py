...
from spflow.tensorly.structure.spn.layer.partition_layer import toLayerBased, toNodeBased
from spflow.tensorly.structure.spn.layer_layerbased.partition_layer import toLayerBased, toNodeBased, updateBackend
