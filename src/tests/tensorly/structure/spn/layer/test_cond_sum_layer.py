...
from spflow.tensorly.structure.spn.layer.cond_sum_layer import toLayerBased, toNodeBased
from spflow.tensorly.structure.spn.layer_layerbased.cond_sum_layer import toLayerBased, toNodeBased, updateBackend
