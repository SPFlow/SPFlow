...
from spflow.tensorly.structure.spn import Binomial, marginalize
...
class TestBinomial(unittest.TestCase):
    def test_initialization(self):
        ...
        # p = inf and p = nan
        self.assertRaises(Exception, Binomial, Scope([0]), 1, tl.inf)
        self.assertRaises(Exception, Binomial, Scope([0]), 1, tl.nan)
        ...
        # n = inf and n = nan
        self.assertRaises(Exception, Binomial, Scope([0]), tl.inf, 0.5)
        self.assertRaises(Exception, Binomial, Scope([0]), tl.nan, 0.5)
