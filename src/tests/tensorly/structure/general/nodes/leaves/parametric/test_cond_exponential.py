...
class TestCondExponential(unittest.TestCase):
    ...
    def test_retrieve_params(self):
        ...
        self.assertTrue(exponential.retrieve_params(tl.tensor([[1.0]]), DispatchContext()) == np.nextafter(0.0, 1.0))
        # l = 0 and l < 0
        ...
        # l = inf and l = nan
        exponential.set_cond_f(lambda data: {"l": tl.inf})
        self.assertRaises(
            ValueError,
            exponential.retrieve_params,
            tl.tensor([[1.0]]),
        ...
        exponential.set_cond_f(lambda data: {"l": tl.nan})
        self.assertRaises(
            ValueError,
            exponential.retrieve_params,
            tl.tensor([[1.0]]),
