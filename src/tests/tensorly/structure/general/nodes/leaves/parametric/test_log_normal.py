...
from spflow.tensorly.structure.spn import LogNormal, marginalize
...
class TestLogNormal(unittest.TestCase):
    def test_initialization(self):
        ...
        self.assertRaises(Exception, LogNormal, Scope([0]), tl.inf, 1.0)
        self.assertRaises(Exception, LogNormal, Scope([0]), -tl.inf, 1.0)
        self.assertRaises(Exception, LogNormal, Scope([0]), tl.nan, 1.0)
        ...
        self.assertRaises(Exception, LogNormal, Scope([0]), mean, tl.inf)
        self.assertRaises(Exception, LogNormal, Scope([0]), mean, -tl.inf)
        self.assertRaises(Exception, LogNormal, Scope([0]), mean, tl.nan)
