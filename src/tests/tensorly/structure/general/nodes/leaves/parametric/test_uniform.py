...
from spflow.tensorly.structure.spn import Uniform, marginalize
...
class TestUniform(unittest.TestCase):
    def test_initialization(self):
        ...
        self.assertRaises(Exception, Uniform, Scope([0]), tl.inf, 0.0)
        self.assertRaises(Exception, Uniform, Scope([0]), -tl.inf, 0.0)
        self.assertRaises(Exception, Uniform, Scope([0]), tl.nan, 0.0)

        # end = +-inf and end = nan
        self.assertRaises(Exception, Uniform, Scope([0]), 0.0, tl.inf)
        self.assertRaises(Exception, Uniform, Scope([0]), 0.0, -tl.inf)
        self.assertRaises(Exception, Uniform, Scope([0]), 0.0, tl.nan)
