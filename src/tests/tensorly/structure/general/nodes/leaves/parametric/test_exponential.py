...
from spflow.tensorly.structure.spn import Exponential, marginalize
...
class TestExponential(unittest.TestCase):
    def test_initialization(self):
        ...
        # l = inf and l = nan
        self.assertRaises(Exception, Exponential, Scope([0]), tl.inf)
        self.assertRaises(Exception, Exponential, Scope([0]), tl.nan)
