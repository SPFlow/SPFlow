...
class TestHypergeometric(unittest.TestCase):
    def test_initialization(self):
        ...
        # N = inf and N = nan
        self.assertRaises(Exception, Hypergeometric, Scope([0]), tl.inf, 1, 1)
        self.assertRaises(Exception, Hypergeometric, Scope([0]), tl.nan, 1, 1)
        # N float
        ...
        # M = inf and M = nan
        self.assertRaises(Exception, Hypergeometric, Scope([0]), 1, tl.inf, 1)
        self.assertRaises(Exception, Hypergeometric, Scope([0]), 1, tl.nan, 1)
        # M float
        ...
        # n = inf and n = nan
        self.assertRaises(Exception, Hypergeometric, Scope([0]), 1, 1, tl.inf)
        self.assertRaises(Exception, Hypergeometric, Scope([0]), 1, 1, tl.nan)
        # n float
