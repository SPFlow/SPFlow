...
class TestGamma(unittest.TestCase):
    ...
    def test_retrieve_params(self):
        ...
        alpha, beta = gamma.retrieve_params(tl.tensor([[1.0]]), DispatchContext())
        ...
        gamma.set_cond_f(lambda data: {"alpha": tl.inf, "beta": 1.0})
        self.assertRaises(
            ValueError,
            gamma.retrieve_params,
            tl.tensor([[1.0]]),
        ...
        gamma.set_cond_f(lambda data: {"alpha": tl.nan, "beta": 1.0})
        self.assertRaises(
            ValueError,
            gamma.retrieve_params,
            tl.tensor([[1.0]]),
        ...
        gamma.set_cond_f(lambda data: {"alpha": 1.0, "beta": tl.inf})
        self.assertRaises(
            ValueError,
            gamma.retrieve_params,
            tl.tensor([[1.0]]),
        ...
        gamma.set_cond_f(lambda data: {"alpha": 1.0, "beta": tl.nan})
        self.assertRaises(
            ValueError,
            gamma.retrieve_params,
            tl.tensor([[1.0]]),
