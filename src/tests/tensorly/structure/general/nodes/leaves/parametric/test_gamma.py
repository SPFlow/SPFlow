...
class TestGamma(unittest.TestCase):
    def test_initialization(self):
        ...
        self.assertRaises(Exception, Gamma, Scope([0]), tl.inf, 1.0)
        self.assertRaises(Exception, Gamma, Scope([0]), tl.nan, 1.0)
        ...
        self.assertRaises(Exception, Gamma, Scope([0]), 1.0, tl.inf)
        self.assertRaises(Exception, Gamma, Scope([0]), 1.0, tl.nan)
