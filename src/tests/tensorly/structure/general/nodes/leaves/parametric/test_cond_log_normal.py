...
class TestLogNormal(unittest.TestCase):
    ...
    def test_retrieve_params(self):
        ...
        log_normal.set_cond_f(lambda data: {"mean": tl.inf, "std": 1.0})
        self.assertRaises(
            ValueError,
        ...
        log_normal.set_cond_f(lambda data: {"mean": tl.nan, "std": 1.0})
        self.assertRaises(
            ValueError,
            log_normal.retrieve_params,
            tl.tensor([[1.0]]),
        ...
        log_normal.set_cond_f(lambda data: {"mean": 0.0, "std": tl.inf})
        self.assertRaises(
            ValueError,
            log_normal.retrieve_params,
            tl.tensor([[1.0]]),
        ...
        log_normal.set_cond_f(lambda data: {"mean": 0.0, "std": tl.nan})
        self.assertRaises(
            ValueError,
            log_normal.retrieve_params,
            tl.tensor([[1.0]]),
