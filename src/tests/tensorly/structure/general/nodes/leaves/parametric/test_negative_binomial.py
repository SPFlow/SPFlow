...
from spflow.tensorly.structure.spn import NegativeBinomial, marginalize
...
class TestNegativeBinomial(unittest.TestCase):
    def test_initialization(self):
        ...
        # p = +-inf and p = nan
        self.assertRaises(Exception, NegativeBinomial, Scope([0]), 1, tl.inf)
        self.assertRaises(Exception, NegativeBinomial, Scope([0]), 1, -tl.inf)
        self.assertRaises(Exception, NegativeBinomial, Scope([0]), 1, tl.nan)
        ...
        # n = inf and = nan
        self.assertRaises(Exception, NegativeBinomial, Scope([0]), tl.inf, 1.0)
        self.assertRaises(Exception, NegativeBinomial, Scope([0]), tl.nan, 1.0)
