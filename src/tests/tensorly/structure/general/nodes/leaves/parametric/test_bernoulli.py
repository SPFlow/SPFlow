...
from spflow.tensorly.structure.spn import Bernoulli, marginalize
...
class TestBernoulli(unittest.TestCase):
    def test_initialization(self):
        ...
        # p = inf and p = nan
        self.assertRaises(Exception, Bernoulli, Scope([0]), tl.inf)
        self.assertRaises(Exception, Bernoulli, Scope([0]), tl.nan)
