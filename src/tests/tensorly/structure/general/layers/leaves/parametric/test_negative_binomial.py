...
class TestLayer(unittest.TestCase):
    ...
    def test_initialization_from_signatures(self):
        ...
        self.assertTrue(tl.all(negative_binomial.n == tl.tensor([3, 5])))
        self.assertTrue(tl.all(negative_binomial.p == tl.tensor([0.5, 0.5])))
    ...
    def test_autoleaf(self):
        ...
        self.assertTrue(tl.all(negative_binomial.n == tl.tensor([3, 5])))
        self.assertTrue(tl.all(negative_binomial.p == tl.tensor([0.75, 0.25])))
        self.assertTrue(negative_binomial.scopes_out == [Scope([0]), Scope([1])])
