...
from spflow.base.structure.general.layers.leaves.parametric.exponential import ExponentialLayer as ExponentialLayerBase
...
from spflow.torch.structure.general.layers.leaves.parametric.exponential import ExponentialLayer as ExponentialLayerTorch
