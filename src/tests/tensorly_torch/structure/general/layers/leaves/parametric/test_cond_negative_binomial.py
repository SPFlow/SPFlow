...
from spflow.base.structure.general.layers.leaves.parametric.cond_negative_binomial import CondNegativeBinomialLayer as CondNegativeBinomialLayerBase
...
from spflow.torch.structure.general.layers.leaves.parametric.cond_negative_binomial import CondNegativeBinomialLayer as CondNegativeBinomialLayerTorch
...
def test_retrieve_params(do_for_all_backends):
    ...
    for n_layer_node, p_layer_node in zip(l.n, l.retrieve_params(tl.tensor([[1]]), DispatchContext())):
        ...
        tc.assertTrue(tl.all(p_layer_node == p_value))
