...
from spflow.torch.structure.general.node.leaf.geometric import Geometric
...
def sample(
    ...
    data[sampling_ids, leaf.scope.query] = leaf.dist.sample((sampling_ids.sum(),)).to(leaf.device) + 1
