...
from spflow.base.structure.general.node.leaf.binomial import (
...
from spflow.tensorly.structure.general.node.leaf.general_binomial import Binomial as GeneralBinomial
