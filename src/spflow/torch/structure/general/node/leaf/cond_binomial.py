...
from spflow.tensorly.structure.general.node.leaf.general_cond_binomial import CondBinomial as GeneralCondBinomial
...
def updateBackend(leaf_node: CondBinomial, dispatch_ctx: Optional[DispatchContext] = None):
    ...
    return GeneralCondBinomial(scope=leaf_node.scope, n=leaf_node.n.data.item(), cond_f=cond_f)