...
from spflow.base.structure.general.node.leaf.cond_gamma import (
    CondGamma as BaseCondGamma,
)
from spflow.tensorly.structure.general.node.leaf.general_cond_gamma import CondGamma as GeneralCondGamma
