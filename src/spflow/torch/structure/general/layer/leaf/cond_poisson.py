...
from spflow.tensorly.structure.general.layer.leaf.general_cond_poisson import CondPoissonLayer as GeneralCondPoissonLayer
...
from spflow.torch.structure.general.node.leaf.cond_poisson import (
    CondPoisson,
)
