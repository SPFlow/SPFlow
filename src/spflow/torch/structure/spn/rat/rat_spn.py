...
from spflow.torch.structure.spn.nodes.node import SPNSumNode, marginalize
from spflow.torch.structure.spn.nodes.cond_node import SPNCondSumNode, marginalize
