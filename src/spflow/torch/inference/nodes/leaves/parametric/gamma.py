...
def log_likelihood(leaf: Gamma, data: torch.Tensor, check_support: bool=True, dispatch_ctx: Optional[DispatchContext]=None) -> torch.Tensor:
    ...
    log_prob: torch.Tensor = torch.empty(batch_size, 1).to(leaf.alpha.device)
