...
def maximum_likelihood_estimation(layer: GeometricLayer, data: torch.Tensor, bias_correction: bool=True, nan_strategy: Optional[Union[str, Callable]]=None) -> None:
    """TODO."""
    ...
    if isinstance(nan_strategy, str):
        ...
        if nan_strategy == "ignore":
            ...
            n_trials = torch.nan_to_num(scope_data, nan=0.0).sum(dim=0)
        else:
