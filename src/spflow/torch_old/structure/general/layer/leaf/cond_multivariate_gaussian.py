...
from spflow.structure.general.layer.leaf import (
    CondMultivariateGaussianLayer as GeneralCondMultivariateGaussianLayer,
)
        ...
        if isinstance(mean, list):
            ...
            # can also be a list of different means
                ...
                mean = [
                    ...
                    else torch.tensor(m, dtype=self.dtype, device=self.device)
                    for m in mean
                ]
        ...
        if isinstance(cov, list):
            ...
            # can also be a list of different covs
                ...
                cov = [
                    ...
                    else torch.tensor(c, dtype=self.dtype, device=self.device)
                    for c in cov
                ]
