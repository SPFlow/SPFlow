...
class Binomial:
    def __new__(cls, scope: Scope, n: int, p: float = 0.5):
        from spflow.tensorly.structure.general.nodes.leaves import Binomial as TensorlyBinomial
        from spflow.torch.structure.general.nodes.leaves import Binomial as TorchBinomial
        """TODO"""
