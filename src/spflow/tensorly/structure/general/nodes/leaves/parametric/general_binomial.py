...
class Binomial:
    def __new__(cls, scope: Scope, n: int, p: float = 0.5):
        from spflow.base.structure.general.nodes.leaves.parametric.binomial import Binomial as TensorlyBinomial
        from spflow.torch.structure.general.nodes.leaves.parametric.binomial import Binomial as TorchBinomial
        """TODO"""
