...
class CondBernoulli:
    def __new__(cls, scope: Scope, cond_f: Optional[Callable] = None):
        from spflow.tensorly.structure.general.nodes.leaves import CondBernoulli as TensorlyCondBernoulli
        from spflow.torch.structure.general.nodes.leaves import CondBernoulli as TorchCondBernoulli
        """TODO"""
