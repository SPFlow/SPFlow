...
class CondGeometricLayer:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Union[Scope, List[Scope]],
        ...
        n_nodes: int = 1,
        **kwargs):
        from spflow.base.structure.general.layers.leaves.parametric.cond_geometric import CondGeometricLayer as TensorlyCondGeometric
        from spflow.torch.structure.general.layers.leaves.parametric.cond_geometric import CondGeometricLayer as TorchCondGeometric
        """TODO"""
