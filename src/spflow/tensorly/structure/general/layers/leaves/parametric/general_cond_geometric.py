...
class CondGeometricLayer:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Union[Scope, List[Scope]],
        ...
        n_nodes: int = 1,
        **kwargs):
        from spflow.tensorly.structure.general.layers.leaves import CondGeometricLayer as TensorlyCondGeometric
        from spflow.torch.structure.general.layers.leaves import CondGeometricLayer as TorchCondGeometric
        """TODO"""
