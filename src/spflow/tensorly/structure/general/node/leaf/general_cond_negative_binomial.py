...
class CondNegativeBinomial:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Scope, n: int, cond_f: Optional[Callable] = None):
        from spflow.base.structure.general.node.leaf.cond_negative_binomial import CondNegativeBinomial as TensorlyCondNegativeBinomial
        from spflow.torch.structure.general.node.leaf.cond_negative_binomial import CondNegativeBinomial as TorchCondNegativeBinomial
        """TODO"""
