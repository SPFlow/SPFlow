...
class CondExponential:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Scope, cond_f: Optional[Callable] = None):
        from spflow.base.structure.general.node.leaf.cond_exponential import CondExponential as TensorlyCondExponential
        from spflow.torch.structure.general.node.leaf.cond_exponential import CondExponential as TorchCondExponential
        """TODO"""
