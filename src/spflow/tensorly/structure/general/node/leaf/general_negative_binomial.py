...
class NegativeBinomial:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Scope, n: int, p: float = 0.5):
        from spflow.base.structure.general.node.leaf.negative_binomial import NegativeBinomial as TensorlyNegativeBinomial
        from spflow.torch.structure.general.node.leaf.negative_binomial import NegativeBinomial as TorchNegativeBinomial
        """TODO"""
