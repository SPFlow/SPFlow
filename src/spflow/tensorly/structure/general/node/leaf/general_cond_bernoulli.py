...
class CondBernoulli:
    def __new__(cls, scope: Scope, cond_f: Optional[Callable] = None):
        from spflow.base.structure.general.node.leaf.cond_bernoulli import CondBernoulli as TensorlyCondBernoulli
        from spflow.torch.structure.general.node.leaf.cond_bernoulli import CondBernoulli as TorchCondBernoulli
        """TODO"""
