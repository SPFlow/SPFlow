...
class Hypergeometric:
    def __new__(cls, scope: Scope, N: int, M: int, n: int):
        from spflow.base.structure.general.node.leaf.hypergeometric import Hypergeometric as TensorlyHypergeometric
        from spflow.torch.structure.general.node.leaf.hypergeometric import Hypergeometric as TorchHypergeometric
        """TODO"""
