...
class NegativeBinomialLayer:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Union[Scope, List[Scope]],
        ...
        n_nodes: int = 1,
        **kwargs):
        from spflow.base.structure.general.layer.leaf.negative_binomial import NegativeBinomialLayer as TensorlyNegativeBinomial
        from spflow.torch.structure.general.layer.leaf.negative_binomial import NegativeBinomialLayer as TorchNegativeBinomial
        """TODO"""
