...
class BinomialLayer:
    def __new__(cls, scope: Union[Scope, List[Scope]], n: Union[int, List[int], T], p: Union[int, float, List[float], T] = 0.5, n_nodes: int = 1,**kwargs):
        from spflow.base.structure.general.layer.leaf.binomial import BinomialLayer as TensorlyBinomial
        from spflow.torch.structure.general.layer.leaf.binomial import BinomialLayer as TorchBinomial
        """TODO"""
