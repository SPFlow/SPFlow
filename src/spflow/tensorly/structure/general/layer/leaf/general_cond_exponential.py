...
class CondExponentialLayer:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Union[Scope, List[Scope]],
        ...
        n_nodes: int = 1,
        **kwargs):
        from spflow.base.structure.general.layer.leaf.cond_exponential import CondExponentialLayer as TensorlyCondExponential
        from spflow.torch.structure.general.layer.leaf.cond_exponential import CondExponentialLayer as TorchCondExponential
        """TODO"""
