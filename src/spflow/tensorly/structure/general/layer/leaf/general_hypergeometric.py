...
class HypergeometricLayer:
    def __new__(cls, scope: Union[Scope, List[Scope]],
        ...
        n_nodes: int = 1,
        **kwargs):
        from spflow.base.structure.general.layer.leaf.hypergeometric import HypergeometricLayer as TensorlyHypergeometric
        from spflow.torch.structure.general.layer.leaf.hypergeometric import HypergeometricLayer as TorchHypergeometric
        """TODO"""
