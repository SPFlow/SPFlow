...
class CondBinomialLayer:  # ToDo: backend über tl.getBackend() abfragen
    def __new__(cls, scope: Union[Scope, List[Scope]],
        ...
        n_nodes: int = 1,
        **kwargs):
        from spflow.base.structure.general.layer.leaf.cond_binomial import CondBinomialLayer as TensorlyCondBinomial
        from spflow.torch.structure.general.layer.leaf.cond_binomial import CondBinomialLayer as TorchCondBinomial
        """TODO"""
