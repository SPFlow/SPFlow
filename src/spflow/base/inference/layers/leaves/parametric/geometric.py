...
def log_likelihood(layer: GeometricLayer, data: np.ndarray, check_support: bool=True, dispatch_ctx: Optional[DispatchContext]=None) -> np.ndarray:
    r"""Computes log-likelihoods for ``GeometricLayer`` leaves in the ``base`` backend given input data.
