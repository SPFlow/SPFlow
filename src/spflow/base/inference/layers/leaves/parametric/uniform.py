...
def log_likelihood(layer: UniformLayer, data: np.ndarray, check_support: bool=True, dispatch_ctx: Optional[DispatchContext]=None) -> np.ndarray:
    r"""Computes log-likelihoods for ``UniformLayer`` leaves in the ``base`` backend given input data.
