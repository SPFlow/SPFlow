...
def log_likelihood(node: CondBernoulli, data: np.ndarray, dispatch_ctx: Optional[DispatchContext]=None) -> np.ndarray:
    r"""Computes log-likelihoods for ``CondBernoulli`` node given input data.
