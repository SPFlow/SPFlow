...
def log_likelihood(node: Gaussian, data: np.ndarray, dispatch_ctx: Optional[DispatchContext]=None) -> np.ndarray:
    r"""Computes log-likelihoods for ``Gaussian`` node given input data.
