...
def log_likelihood(node: CondGaussian, data: np.ndarray, check_support: bool=True, dispatch_ctx: Optional[DispatchContext]=None) -> np.ndarray:
    r"""Computes log-likelihoods for ``CondGaussian`` node given input data in the ``base`` backend.
