...
def log_likelihood(node: CondBinomial, data: np.ndarray, dispatch_ctx: Optional[DispatchContext]=None) -> np.ndarray:
    r"""Computes log-likelihoods for ``CondBinomial`` node given input data.
