...
def log_likelihood(node: Exponential, data: np.ndarray, dispatch_ctx: Optional[DispatchContext]=None) -> np.ndarray:
    r"""Computes log-likelihoods for ``Exponential`` node given input data.
