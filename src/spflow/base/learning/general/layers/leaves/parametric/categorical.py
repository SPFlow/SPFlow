"""Contains learning methods for ``CategoricalLayer`` leaves for SPFlow in the ``base`` backend.
"""
from typing import Callable, Optional, Union

import numpy as np

from spflow.base.learning.general.nodes.leaves.parametric.categorical import (
...
def maximum_likelihood_estimation(
    ...
    r"""Maximum (weighted) likelihood estimation (MLE) of ``CategoricalLayer`` leaves' parameters in the ``base`` backend.
