...
from spflow.base.learning.nodes.leaves.parametric.geometric import Geometric
from spflow.base.structure.layers.leaves.parametric.geometric import GeometricLayer


@dispatch(memoize=True) # TODO: swappable
def maximum_likelihood_estimation(leaf: GeometricLayer, data: np.ndarray, bias_correction: bool=True, nan_strategy: Optional[Union[str, Callable]]=None) -> None:
    """TODO."""
