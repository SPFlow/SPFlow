...
from spflow.base.structure.layers.leaves.parametric.bernoulli import BernoulliLayer


@dispatch(memoize=True)  # type: ignore
def maximum_likelihood_estimation(layer: BernoulliLayer, data: np.ndarray, weights: Optional[np.ndarray]=None, bias_correction: bool=True, nan_strategy: Optional[Union[str, Callable]]=None, check_support: bool=True, dispatch_ctx: Optional[DispatchContext]=None) -> None:
