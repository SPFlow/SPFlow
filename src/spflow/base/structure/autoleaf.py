...
from spflow.base.structure.general.layers.leaves.parametric.categorical import Categorical, CategoricalLayer
...
from spflow.base.structure.general.layers.leaves.parametric.cond_categorical import CondCategorical, CondCategoricalLayer
