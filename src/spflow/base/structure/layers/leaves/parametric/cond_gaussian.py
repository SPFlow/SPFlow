...
class CondGaussianLayer(Module):
    ...
    @classmethod
    def from_signatures(self, signatures: List[Tuple[List[Union[MetaType, FeatureType, Type[FeatureType]]], Scope]]) -> "CondGaussianLayer":
        """TODO"""
        ...
        for types, scope in signatures:
            ...
            if type == MetaType.Continuous or type == FeatureTypes.Gaussian or isinstance(type, FeatureTypes.Gaussian):
                ...
                raise ValueError(f"Unknown signature type {type} for 'CondGaussianLayer' that was not caught during acception checking.")
