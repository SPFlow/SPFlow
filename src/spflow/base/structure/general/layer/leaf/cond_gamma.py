...
from spflow.base.structure.general.node.leaf.cond_gamma import CondGamma
from spflow.tensorly.structure.spn.layer.leaf import CondGammaLayer as GeneralCondGammaLayer
