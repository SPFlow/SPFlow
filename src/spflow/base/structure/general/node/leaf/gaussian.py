...
from spflow.tensorly.structure.spn.node.leaf import Gaussian as GeneralGaussian
...
def updateBackend(leaf_node: Gaussian, dispatch_ctx: Optional[DispatchContext] = None):
    ...
    return GeneralGaussian(scope=leaf_node.scope, mean=leaf_node.mean, std=leaf_node.std)