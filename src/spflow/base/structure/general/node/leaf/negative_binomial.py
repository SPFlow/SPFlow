...
from spflow.tensorly.structure.spn.node.leaf import NegativeBinomial as GeneralNegativeBinomial
...
def updateBackend(leaf_node: NegativeBinomial, dispatch_ctx: Optional[DispatchContext] = None):
    ...
    return GeneralNegativeBinomial(scope=leaf_node.scope, n=leaf_node.n, p=leaf_node.p)