...
from spflow.tensorly.structure.spn.node.leaf import CondBernoulli as GeneralCondBernoulli
...
class CondBernoulli(LeafNode):
    ...
    def from_signatures(cls, signatures: List[FeatureContext]) -> "CondBernoulli":
        ...
        if (
            ...
            raise ValueError(
                f"Unknown signature type {domain} for 'CondBernoulli' that was not caught during acception checking."
            )
