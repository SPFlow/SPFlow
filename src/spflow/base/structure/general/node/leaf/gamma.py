...
from spflow.tensorly.structure.spn.node.leaf import Gamma as GeneralGamma
...
def updateBackend(leaf_node: Gamma, dispatch_ctx: Optional[DispatchContext] = None):
    ...
    return GeneralGamma(scope=leaf_node.scope, alpha=leaf_node.alpha, beta=leaf_node.beta)