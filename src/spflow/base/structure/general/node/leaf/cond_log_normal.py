...
from spflow.tensorly.structure.spn.node.leaf import CondLogNormal as GeneralCondLogNormal
from spflow.base.structure.general.node.leaf_node import LeafNode
...
class CondLogNormal(LeafNode):
    ...
    def __init__(self, scope: Scope, cond_f: Optional[Callable] = None) -> None:
        ...
        if len(scope.evidence) == 0:
            raise ValueError(f"Evidence scope for LogNormal should not be empty.")
