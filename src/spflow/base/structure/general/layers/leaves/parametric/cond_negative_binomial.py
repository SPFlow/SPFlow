...
from spflow.tensorly.structure.spn.layers.leaves.parametric import CondNegativeBinomialLayer as GeneralCondNegativeBinomialLayer
...
def updateBackend(leaf_node: CondNegativeBinomialLayer, dispatch_ctx: Optional[DispatchContext] = None):
    ...
    return GeneralCondNegativeBinomialLayer(scope=leaf_node.scopes_out,n=leaf_node.n, cond_f=cond_f)
