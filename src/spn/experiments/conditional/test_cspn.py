...
if __name__ == '__main__':
    ...
    num3_img = stitch_imgs(imgs=1, img_size=(28 * blocks, 28 * blocks), num_blocks=(blocks, blocks),
    ...
    num5_img = stitch_imgs(imgs=1, img_size=(28 * blocks, 28 * blocks), num_blocks=(blocks, blocks),
    ...
    spectral_embedding_data = manifold.SpectralEmbedding(n_components=10, random_state=17,
    ...
    spectral_embedding_data = manifold.SpectralEmbedding(n_components=20, random_state=17,
                                                         eigen_solver="arpack").fit_transform(data)
    ...
    spectral_embedding_data = manifold.SpectralEmbedding(n_components=5, random_state=17,
                                                         eigen_solver="arpack").fit_transform(data)
